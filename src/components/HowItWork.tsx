...
const HowItWork: React.FC = (): JSX.Element => {
  return (
    <div className="relative overflow-hidden py-14 lg:py-16">
      <h2 className="h2 text-center text_pattern mb-6 lg:mb-14">How it works?</h2>
      <div className="card_grid max-w-1105px mx-auto px-9 xl:px-0 relative">
        ...
        <div className="icon_pattern absolute right-0 lg:-right-22px xl:-right-55px -bottom-57px lg:top-1.5">
          <Image
            className="w-44px h-94px object-contain lg:w-70px lg:h-146px"
            src={"/pattern/Vector6.png"}
            width={70}
            height={146}
            alt="pattern2"
          />
