...
import BrandSlider from "@/src/components/ampli5/brandSlider";
import MarqueeSlide from "@/src/components/ampli5/marquee";
import Image from "next/image";
import HowItWork from "@/src/components/ampli5/HowItWork";
import IconText from "@/src/components/ampli5/Icontext";
import CardImage from "@/src/components/ampli5/CardImage";
import PrimaryButton from "@/src/components/ui/PrimaryButton";
import { useRouter } from "next/navigation";
import WaveContent from "@/src/components/ampli5/WaveContent";
import EffectSlider from "@/src/components/ampli5/EffectSlider";
import CaseStudies from "@/src/components/ampli5/CaseStudies";
  ...
  return (
    <>
      <div className="bg_square bg_square_bottom relative overflow-hidden bg-white">
        <div className="absolute top-18px md:top-9 lg:top-11 md:-left-7 z-10">
          <Image
