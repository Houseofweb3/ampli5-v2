        ...
        <div className="h-full w-full flex  items-stretch justify-evenly">
          <div className="h-full text-center">
            ...
            <div className="sm:space-y-8 space-y-4 mt-10">
              ...
              <p className="text-white">Ampli5 has an SLM to learn from the most viral hooks</p>
            </div>
          </div>
          <div className="h-full text-center">
          ...
          <div className="h-full text-center ">
            ...
            <div className="sm:space-y-8 space-y-4 mt-10">
              ...
              <p className="text-white">Traditional agencies take 72 hours to start production</p>
              <p className="text-white">
                Traditional agencies use CHAT GPT to write scripts with poor prompt engineering
                skills
              </p>
            </div>
          </div>
