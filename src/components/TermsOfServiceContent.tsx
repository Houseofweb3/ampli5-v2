...
/** Full Terms of Service content – shared by /terms-of-service and proposal Step 4. */
  ...
  return (
    <div className="space-y-6">
      <div className="space-y-4">
        ...
        <p className="text-sm text-gray-500">Last updated: 25/10/2025</p>
      </div>
      ...
      <section className="space-y-4">
        <h3 className="text-xl font-semibold text-gray-900">1. Nature of Services</h3>
        <p className="leading-relaxed text-gray-700">
      ...
      <section className="space-y-4">
        ...
        <ul className="list-disc pl-6 space-y-2 text-gray-700">
          ...
          <li>Content clipping and redistribution</li>
          <li>Social media execution or coordination</li>
          <li>Community engagement tools including Zealy or equivalent platforms</li>
      ...
      <section className="space-y-4">
        <h3 className="text-xl font-semibold text-gray-900">3. No Guarantees or Representations</h3>
        <p className="leading-relaxed text-gray-700">
          The Company makes no representations or warranties, express or implied, regarding:
        </p>
        <ul className="list-disc pl-6 space-y-2 text-gray-700">
          <li>Reach, impressions, engagement, installs, conversions, revenue, or growth</li>
          <li>Market perception, community behavior, or brand sentiment</li>
          <li>Token price, liquidity, trading activity, holder count, or market stability</li>
        </ul>
        <p className="leading-relaxed text-gray-700">
          Any benchmarks, projections, CPMs, CTRs, case studies, estimates, or past results are
          illustrative only and do not constitute guarantees.
        </p>
      </section>
      ...
      <section className="space-y-4">
        ...
        <p className="leading-relaxed text-gray-700">
          The Company has no control over algorithm changes, account suspensions, restrictions,
          editorial decisions, influencer conduct, or platform enforcement actions.
        </p>
        <p className="leading-relaxed text-gray-700">
      ...
      <section className="space-y-4">
        <h3 className="text-xl font-semibold text-gray-900">5. Client Responsibilities</h3>
        <p className="leading-relaxed text-gray-700">The Client is solely responsible for:</p>
        <ul className="list-disc pl-6 space-y-2 text-gray-700">
          <li>Accuracy, legality, and compliance of all provided content</li>
          <li>Product claims, disclosures, and representations</li>
          <li>
            Token mechanics, liquidity actions, burns, unlocks, emissions, supply changes, or
      ...
      <section className="space-y-4">
        ...
        <p className="leading-relaxed text-gray-700">
          Delayed Client feedback, approvals, or provision of required inputs may extend timelines
          without penalty or liability to the Company.
        </p>
        <p className="leading-relaxed text-gray-700">
      ...
      <section className="space-y-4">
        <h3 className="text-xl font-semibold text-gray-900">7. Fees, Payment, and Refunds</h3>
        <p className="leading-relaxed text-gray-700">
      ...
      <section className="space-y-4">
        <h3 className="text-xl font-semibold text-gray-900">8. Dispute Notice and Resolution</h3>
        <p className="leading-relaxed text-gray-700">
          Any dispute must be raised in writing within ten (10) calendar days from the date the
          issue arises.
        </p>
        <p className="leading-relaxed text-gray-700">
      ...
      <section className="space-y-4">
        ...
        <p className="leading-relaxed text-gray-700 pl-4">
          ...
          <br />
          (b) the total fees actually paid by the Client to the Company during the fifteen (15)
          calendar days immediately preceding the event giving rise to the claim.
        </p>
        <p className="leading-relaxed text-gray-700">For the avoidance of doubt:</p>
        <ul className="list-disc pl-6 space-y-2 text-gray-700">
          ...
          <li>
            The Client expressly waives any right to aggregate claims across multiple invoices,
            campaigns, billing cycles, or statements of work
          </li>
        </ul>
        <p className="leading-relaxed text-gray-700">
          In no event shall the Company be liable for indirect, incidental, consequential,
          reputational, or market-related damages.
        </p>
      </section>
      ...
      <section className="space-y-4">
        ...
        <p className="leading-relaxed text-gray-700">
          The Company shall not be liable for token price movements, market crashes, loss of
          confidence, delistings, exchange actions, or decisions by founders, DAOs, market makers,
          or liquidity providers.
        </p>
        <p className="leading-relaxed text-gray-700">
          Any discussion or illustration relating to token performance is non-binding and
          non-promissory.
        </p>
      </section>
      ...
      <section className="space-y-4">
        <h3 className="text-xl font-semibold text-gray-900">11. Termination</h3>
        <p className="leading-relaxed text-gray-700">
          The Company may suspend or terminate services immediately for:
        </p>
        <ul className="list-disc pl-6 space-y-2 text-gray-700">
          <li>Non-payment</li>
          <li>Illegal, misleading, or deceptive activity</li>
      ...
      <section className="space-y-4">
        <h3 className="text-xl font-semibold text-gray-900">13. Entire Agreement and Amendments</h3>
        <p className="leading-relaxed text-gray-700">
      ...
      <section className="space-y-4">
        <h3 className="text-xl font-semibold text-gray-900">14. Acknowledgment</h3>
        <p className="leading-relaxed text-gray-700">
          By using Ampli5, the Client acknowledges and agrees that:
        </p>
        <ul className="list-disc pl-6 space-y-2 text-gray-700">
          <li>Services are execution-based with no guaranteed outcomes</li>
          <li>Crypto and token-related risks are borne solely by the Client</li>
          <li>Liability is strictly limited as set out herein</li>
          <li>Disputes are governed exclusively by these Terms</li>
        </ul>
        <div className="space-y-4 text-gray-700 leading-relaxed">
          <p>
            This document is issued in reference to the Ampli5 Terms & Conditions, available at:{" "}
            <a
          ...
          <p>
            To ensure clarity and consistency, the Ampli5 Terms & Conditions apply to the services
            outlined herein and shall prevail in the event of any inconsistency.
          </p>
          <p>
            Continued engagement, review, confirmation, or payment indicates acceptance of the
            Ampli5 Terms & Conditions, including applicable limitations of liability and dispute
            resolution provisions.
          </p>
          <p>
            Any variations or additional understandings, if required, will be confirmed in writing
            via email by both parties.
          </p>
        </div>
      </section>
      ...
      <section className="space-y-4">
        <p className="leading-relaxed text-gray-700 text-center">
          For any further queries on the above please send an email to{" "}
          <a
            href="mailto:finance@houseofweb3.com"
