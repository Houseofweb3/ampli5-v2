...
export async function POST(request: Request) {
    try {
        ...
        if (!formData.fullName?.trim() || !formData.startupName?.trim() || !formData.startupDescription?.trim()) {
        ...
        const hasGoogleConfig = process.env.SPREAD_SHEET_EMAIL && process.env.GOOGLE_KEY && process.env.SPREAD_SHEET_ID;
        ...
        if (hasGoogleConfig) {
            ...
            console.log('Google Sheets environment variables not configured. Logging form data:', formData);
        }
