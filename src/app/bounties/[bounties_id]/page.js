            ...
            <Card className="ctm_bounties_details p-4 lg:p-9">
              ...
              <div className='mb-9'>
                ...
                <ul className='p-0 m-0'>
                  <li className='list-none'>Fully on-chain perpetual trading with up to 50x leverage</li>
                  <li className='list-none'>SBT-based reputation system for on-chain identity and airdrop eligibility</li>
                  <li className='list-none'>DAO governance and reward distribution tied to protocol usage</li>
                </ul>
              </div>
              <div className='mb-9'>
                <h2 className='mb-2'>Call to Action</h2>
                <ul className='p-0 m-0'>
                  <li className='list-none'><strong>Join ZEUS Exchange’s testnet today, mint your SBT, and start earning points toward one of the most sustainable airdrops on Base.</strong></li>
                  <li className='list-none'>Trade, stake, and build your on-chain reputation — the gods favor ZEUS.</li>
                </ul>
              </div>
              <div className=''>
              <h2>Founder/Team</h2>
               ...
               <div className='flex items-start flex-col gap-2'>
                  <div className='border border-solid border-black/15 p-6 rounded-2xl w-full flex flex-col items-end gap-4'>
                    <ul className='p-0 m-0'>
                        ...
                        <li className='list-none text-18'>✅ A Base-native innovation for long-term user alignment</li>
                    </ul>
                  </div>
               </div>
               <div className='flex items-start flex-col gap-2'>
                  <div className='border border-solid border-black/10 p-6 rounded-2xl w-full flex flex-col items-end gap-4'>
                    <ul className='p-0 m-0'>
                      ...
                      <li className='list-none text-18'>❌ Calling it custodial or semi-centralized — ZEUS is fully on-chain</li>
                    </ul>
                  </div>
               </div>
              </div>
