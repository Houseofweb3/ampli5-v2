...
export default function BrandIntakeForm() {
  ...
  useEffect(() => {
    ...
    if (formData.brandProductName && formData.websiteLink && formData.primaryContactEmail && (formData.telegramId?.trim() || formData.whatsappNumber?.trim())) completed.add(1);
    ...
    switch (step) {
      case 1:
        ...
        if (!formData.websiteLink.trim()) {
          ...
          if (!looksLikeDomain) {
            newErrors.websiteLink = 'Please enter a valid URL or domain (e.g. example.com or www.example.com)';
          }
        }
                ...
                <SwiperSlide>
                  <div className="space-y-6 w-full">
                    ...
                    <div>
                      ...
                      <div className={`flex w-full rounded-lg border bg-white ${errors.websiteLink ? 'border-red-500' : 'border-gray-300'} focus-within:ring-2 focus-within:ring-[#7B46F8] focus-within:border-transparent`}>
                        ...
                        <input
                          type="text"
                          value={formData.websiteLink.startsWith('http') ? formData.websiteLink : formData.websiteLink.replace(/^www\./i, '')}
                          onChange={(e) => {
                      ...
                      <p className="mt-1 text-xs text-gray-500">Enter domain with or without www (e.g. example.com or full URL)</p>
                      {errors.websiteLink && (
