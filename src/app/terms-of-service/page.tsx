  ...
  return (
    <Container className="py-12 sm:py-20">
      <div className="max-w-4xl mx-auto space-y-8">
        ...
        <section className="space-y-4">
          <h2 className="text-2xl font-semibold text-gray-900">5. Client Responsibilities</h2>
        ...
        <section className="space-y-4">
          <h2 className="text-2xl font-semibold text-gray-900">7. Fees, Payment, and Refunds</h2>
          <p className="leading-relaxed text-gray-700">
        ...
        <section className="space-y-4">
          <h2 className="text-2xl font-semibold text-gray-900">8. Dispute Notice and Resolution</h2>
          <p className="leading-relaxed text-gray-700">
        ...
        <section className="space-y-4">
          <h2 className="text-2xl font-semibold text-gray-900">12. Confidentiality</h2>
          <p className="leading-relaxed text-gray-700">
        ...
        <section className="space-y-4">
          <h2 className="text-2xl font-semibold text-gray-900">14. Acknowledgment</h2>
          <p className="leading-relaxed text-gray-700">
